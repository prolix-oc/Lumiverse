...
| `"decisions"` | Privileged access to evaluate structured Choice, Score, and Noul questions using the user's decision connection. Requires its own explicit grant; `generation` does not grant it. |
