...
export const CANONICAL_MOUNT_PLACEMENTS: readonly CanonicalMountRecord[] = [
  ...
  { literal: 'loom_block_editor_actions', hostFiles: ['frontend/src/components/panels/LoomBuilder.tsx'], region: 'BlockEditor header immediately after the native Back action', cardinality: 'S', scopeTemplate: 'loom-block:${block.id}:editor-actions' },
