...
const DOMAIN_ROWS: readonly AuthorityRow[] = [
  ...
  gated('decisions', { surface: 'ctx_member', id: 'ctx.decisions.evaluate', source: 'decisions.evaluate', ctxLeaf: 'ctx.decisions.evaluate', gatedBecause: 'Uses the authenticated user decision connection and its stored provider credential' }),
