export function DreamSummary({ dreamText, tone, dislikes }: { dreamText: string; tone: string | null; dislikes: string | null }) {
  return (
    <div style={{
      ...
      <div style={{ color: "var(--lumiverse-primary-text)", fontSize: 10.5, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4, fontWeight: 700 }}>Dream</div>
      <div>{dreamText}</div>
      {(tone || dislikes) && (
