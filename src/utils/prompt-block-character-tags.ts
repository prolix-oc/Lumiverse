...
export function sanitizePromptBlockCharacterTagTrigger(value: unknown): string[] {
...
export function promptBlockMatchesCharacterTags(
  trigger: unknown,
  characterTags: unknown,
): boolean {
  const requiredTags = sanitizePromptBlockCharacterTagTrigger(trigger);
