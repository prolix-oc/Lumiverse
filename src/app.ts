...
import { decisionConnectionsRoutes } from "./routes/decision-connections.routes";
...
app.route("/api/v1/decision-connections", decisionConnectionsRoutes);
app.route("/api/v1/decisions", decisionsRoutes);
