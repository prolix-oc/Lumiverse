...
export const BUILT_IN_SETTINGS_TABS: readonly SpindleUISettingsTabEntry[] = [
  ...
  { id: "agentRuntime", shortName: "Agent Runtime", tabName: "Agent Runtime", tabDescription: "Review runtime defaults, retention, and host-owned ceilings", keywords: ["agent", "runtime", "agentic", "defaults", "retention", "limits", "isolate", "workspace"] },
