...
- **Roleplay as a specific character** — Give yourself a name, description, and avatar for the RP
- **Consistent identity** — The AI references your persona description instead of guessing who you are
- **Multiple identities** — Switch between different personas for different characters or scenarios
- **Attached lore** — Link a world book to your persona so your personal lore is always available
...
- [Creating Personas](creating-personas.md) — Set up your first persona
- [Bindings & Add-Ons](bindings-and-addons.md) — Auto-activate personas and extend them with toggleable blocks
